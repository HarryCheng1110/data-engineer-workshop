...
@click.option("--pg-port", default="5431", show_default=True, help="Postgres port")
...
@click.option("--chunk-size", default=100000, show_default=True, type=int, help="Rows per chunk when reading CSV")
